...
$("#skuOptions").children("div.tb-prop").find("li[data-value]").click(function(){
	...
	if(selectedSku){
		...
		//更新产品媒体
		for(var i=0; i < selectedSku.productMedias.length; i++){
			var media = selectedSku.productMedias[i];
			var index = i;
		}
...
<c:forEach items="${productRules}" var="rule" varStatus="status">
	${status.index + 1 } : ${rule.ruleName }<br/>
</c:forEach>
